...
#ifndef BEAST_SSL_SOCKET_HPP
#define BEAST_SSL_SOCKET_HPP
...
public:
    ...
    using impl_struct = stream_type::impl_struct;

    /// (Deprecated: Use native_handle_type.) The underlying implementation type.
    using impl_type = stream_type::impl_type;
    ...
    ssl_socket(boost::asio::io_service& ios,
            boost::asio::ssl::context& ctx)
        : p_(new stream_type{ios, ctx})
    {
    }
