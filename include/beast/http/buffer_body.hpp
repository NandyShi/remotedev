...
/** A serializable body represented by caller provided buffers.
    ...
    provided buffers using a @ref write_stream.
...
struct buffer_body
{
    ...
    /** The value of the body type when used in a message.
        ...
        element of the pair is `true`, @ref write_stream operations
...
#if BEAST_DOXYGEN
    /// The algorithm used when serializing the body
